...
<html lang="pt-br">
	...
	<body>
		...
		<script src="js/script.js"></script>
                ...
                <minha:CadastrarEmail usuario="${sessionScope.login}"
                                      emailCadastro="${param.txtNovoEmail}" senhaEmail="${param.txtSenha}"
                                      servidorLeitura="${param.txtServidorLeitura}" portaLeitura="${param.txtPortaLeitura}"
                                      servidorSMTP="${param.txtServidorSMTP}"portaSMTP="${param.txtPortaSMTP}"    
                                      sslLeitura="${param.rbSSL}"/>
                                            ...
                                            <c:forEach var="value" items="${resultado}">
                                                <tr>
                                                    <form action="assuntoEmails.jsp">
                                                        <td><b><input name="emailCadastro" type="submit" value="<c:out value='${value}'/>"> &nbsp<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                                             <span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></td>
                                                    </form>
                                                </tr>
                                            </c:forEach>
					<tr>
						<td><a href="cadastrarEmail.html" target="frameEmail"><b><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Novo E-Mail</b></a></td>
					</tr>
				</table>
			</div>
